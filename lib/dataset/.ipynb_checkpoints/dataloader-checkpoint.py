...
from vpgnet_dataset import VPGDataset as vpg
...
def make_vpg_train_valid_loader():
    train_loader = DataLoader(
        vpg('train'),
        batch_size = 16,
        shuffle = True,
...
if __name__ == '__main__':
    ...
    vpg_train_loader, vpg_valid_loader = make_vpg_train_valid_loader()
    vpg_test_loader = make_vpg_test_loader()
    print(len(vpg_train_loader), len(vpg_valid_loader), len(vpg_test_loader))
